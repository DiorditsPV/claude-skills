...
| [meeting-notes](skills/meeting-notes/SKILL.md) | Протокол одной встречи из транскрипта: суть, решения, поручения с владельцем и сроком, открытые вопросы, разногласия — с привязкой к моменту разговора | нет |
